                ...
                <div class="container mt-5 ">
                    <div class="row">
                        <div class="col-lg-12 mx-auto bg-light rounded-3 p-4">
                            ...
                            <div class="mb-3">
                                <textarea id="description" class="form-control" rows="4" required name="desc"  placeholder="WRITE A YOUR TOPIC">
                            ...
                            <div class="mb-3">
                                <input type="submit" name="add" class="btn btn-outline-success m-1">
                            </div>
                        ...
                        <?php 
                           ...
                           if(isset($_POST['add']))
                           {
                            ...
                            // $postby=$_POST['postby'];
                             ...
                             echo $slug;
                             $desc=$_POST['desc'];
                             $sql="INSERT INTO `posts`( `title`, `description`, `slug`, `posted_by`, `date`) VALUES ('$title','$desc','$slug','Admin','$ctd')";
