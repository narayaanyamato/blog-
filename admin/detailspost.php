            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-3 text-center text-info">Add Post</h1>
                     <hr>
                                         ...
                                         <?php
                                            ...
                                            <tr>
                                             ...
                                             <td><a href="<?php echo $permalink; ?>"><?php echo substr($title, 0, 50); ?></a></td>
                                                 <td>
                                                    <a href="update.php?id=<?php echo $row['id']; ?>" name="update"> <button class="btn btn-outline-success m-1"> Ediit </button></a>
                                                     <a href="delete.php?id=<?php echo $row['id']; ?>" name="delete"> <button class="btn btn-outline-danger m-1">Detlete</button></a>
...
<?php 
  ...
  if(isset($_POST['add']))
  {
    ...
    $sql="INSERT INTO `post`(`id`, `title`, `subtitle`, `cato`, `img`, `desc1`) VALUES (null,'$title','$subtitle','$cato','$fname','$desc')";

    if(mysqli_query($con,$sql))
    {
         echo "<script>alert('post Added Successfully'); window.open('index.php','_blank');</script>";
    }
    else
    {
